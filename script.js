...
function reveal() {
    ...
    var reveals = document.querySelectorAll(".reveal-l,.reveal-r,.reveal-up-0_5,.reveal-up-1_0,.reveal-up-1_5,.reveal-up-2_0,.reveal-fade,.border-design-upside-down,.border-design");
